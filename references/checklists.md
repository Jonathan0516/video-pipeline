...
```text
Use $avatar-video-skill to make only a 15-second preview.
...
```text
Use $avatar-video-skill to continue from work/job-state.json.
...
```text
Use $avatar-video-skill for batch preview production.
