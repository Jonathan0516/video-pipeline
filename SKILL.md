...
description: Public-safe MiniMax overseas voice clone and HeyGen API workflow for creating avatar talking-head videos. Use when Codex is asked to make, automate, QA, or batch-produce authorized 数字人/口播 videos from a script, portrait, voice sample, MiniMax voice cloning, HeyGen Image-to-Video, HeyGen Photo Avatar, a 15-second preview, full-video generation, or job-state tracking.
---
