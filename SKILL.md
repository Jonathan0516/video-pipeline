...
- Require the user to confirm that the voice, portrait, script, and final use are authorized before generating narration or video.
...
- If a voice source file is used, format must be MP3, M4A, or WAV.
- If a voice source file is used, duration should be 10 seconds to 5 minutes and size 20 MB or less.
